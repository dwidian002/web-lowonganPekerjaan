    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Company's Detail</span>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="doctor-img-block">
					@if ($companies->logo)
                <img src="{{ asset('storage/' . $companies->logo) }}" alt="{{ $companies->company_name }}" class="img-fluid">
            		@else
                <img src="{{ asset('layout/assets/images/service/default-logo.jpg') }}" alt="Default Logo" class="img-fluid">
            		@endif

					<div class="info-block mt-4">
						<h1 class="mb-0">{{$companies->company_name}}</h1>
						<p><strong>Industry :</strong> {{ $companies->industry }}</p>
            			<p><strong>Tahun Berdiri :</strong> {{ $companies->tahun_berdiri }}</p>
            			<p><strong>Location :</strong> {{ $companies->location->name }}</p>
			...
			<div class="col-lg-8 col-md-6">
				<div class="doctor-details mt-4 mt-lg-0">
					...
					<p style="word-wrap: break-word; overflow-wrap: break-word; max-width: 300px;">
						{{ $companies->description }}
					</p>
					<p><strong>Website:</strong> 
						<a href="{{ $companies->website }}" target="_blank" style="word-wrap: break-word; overflow-wrap: break-word; max-width: 300px;">
							{{ $companies->website }}
						</a>
					</p>
					<p><strong>Location :</strong> {{ $companies->location->name }} </p>
					<p style="word-wrap: break-word; overflow-wrap: break-word; max-width: 300px;">
						<strong>Address :</strong> {{ $companies->alamat_lengkap }}
					</p>
