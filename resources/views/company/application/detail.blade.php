                                ...
                                <div class="col-md-8">
                                    <div class="profile-details">
                                        <div class="detail-row hover:bg-gray-50 p-3 rounded-lg transition-all">
                                            <div class="detail-label text-blue-600">Name</div>
                                            <div class="detail-value font-medium">{{ $application->user->applicantProfile->name ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row hover:bg-gray-50 p-3 rounded-lg transition-all">
                                            <div class="detail-label text-blue-600">Gender</div>
                                            <div class="detail-value font-medium">{{ $application->user->applicantProfile->gender ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row hover:bg-gray-50 p-3 rounded-lg transition-all">
                                            <div class="detail-label text-blue-600">Address</div>
                                            <div class="detail-value font-medium">{{ $application->user->applicantProfile->alamat_lengkap ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row hover:bg-gray-50 p-3 rounded-lg transition-all">
                                            <div class="detail-label text-blue-600">About</div>
                                            <div class="detail-value font-medium">{{ $application->user->applicantProfile->about_me ?? '-' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <div class="grid grid-cols-1 gap-3">
                                    <div class="detail-row">
                                        <div class="detail-label text-blue-600">Degree</div>
                                        <div class="detail-value font-medium">{{ $application->user->applicantProfile->education->degree ?? '-' }}</div>
                                    </div>
                                    <div class="detail-row">
                                        <div class="detail-label text-blue-600">Institution</div>
                                        <div class="detail-value font-medium">{{ $application->user->applicantProfile->education->institution_name ?? '-' }}</div>
                                    </div>
                                    <div class="detail-row">
                                        <div class="detail-label text-blue-600">Duration</div>
