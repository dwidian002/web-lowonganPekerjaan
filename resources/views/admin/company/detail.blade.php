...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card shadow-lg mb-4 border-left-success">
                <div class="card-header py-2 bg-gradient-success text-white d-flex justify-content-between align-items-center">
    ...
    <div class="card shadow-lg mb-4 border-left-info">
        <div class="card-header py-2 d-flex justify-content-between align-items-center bg-gradient-info text-white">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge {{ $job->status ? 'badge-success' : 'badge-danger' }} mr-2">
