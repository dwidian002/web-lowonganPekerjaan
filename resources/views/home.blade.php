...
<body>
    ...
    <section class="achievement-section set-bg spad" data-setbg="assets/img/achievement-bg.jpg">
        <div class="container">
            <div class="row">
